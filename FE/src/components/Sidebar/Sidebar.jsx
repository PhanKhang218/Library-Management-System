              ...
              <ul className="menu-links">
                ...
                <li className="nav-link">
                  <a href="/chart">
                    ...
                    <span className="text nav-text">Câu lạc bộ</span>
                  </a>
                </li>
                <li className="nav-link">
                  <a href="/chart">
                ...
                <li className="nav-link">
                  <a href="/noti">
                    ...
                    <span className="text nav-text">Thông báo</span>
                  </a>
                </li>
                {account?.Role === "Teacher" && (
                  <li className="nav-link">
                    <a href="/grade">
                      ...
                      <span className="text nav-text">Lịch tập</span>
                    </a>
                  </li>
                )}
                {account?.Role === "Parent" && (
                  <li className="nav-link">
                    <a href={`/checkpoint/${account?.MoreInfo[0].StudentID}`}>
                      <i className="bx bx-pie-chart-alt icon" />
                      <span className="text nav-text">Thu Phí</span>
                    </a>
                  </li>
                )}
                <li className="nav-link">
                  <a href="/forum">
                    ...
                    <span className="text nav-text">Diễn đàn</span>
                  </a>
                </li>
                ...
                <li className="nav-link">
                  <a href="/form">
                    ...
                    <span className="text nav-text">Giấy phép</span>
                  </a>
                </li>
                <li className="nav-link">
                  <a href="/cost">
                    <i className="bx bx-wallet icon" />
                    <span className="text nav-text">Chi tiêu</span>
                  </a>
                </li>
                {/* <li className="nav-link">
                                    <a href="/chat">
